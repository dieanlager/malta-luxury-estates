...
import { Calculator, TrendingUp, ShieldCheck, ArrowRight, Home, Scale } from 'lucide-react';
...
export const InteractiveTools = () => {
    const [activeTab, setActiveTab] = useState<'buying' | 'roi' | 'selling' | 'mortgage' | 'buyvsrent'>('buying');
