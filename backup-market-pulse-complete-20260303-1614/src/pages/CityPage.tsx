...
import { ChevronRight, MapPin, ArrowLeft, Home, TrendingUp, Info, Award, DollarSign, Waves, Building } from 'lucide-react';
...
export const CityPage: React.FC<CityPageProps> = ({
  ...
  const pageTitle = location
    ? `${location.nameEn} Properties for Sale & Rent in ${islandLabel} | Malta Luxury Real Estate`
    : 'Properties | Malta Luxury Real Estate';

  usePageMeta({
    title: pageTitle,
    description: location
      ? `Browse ${stats?.listingsSaleCount || ''} luxury properties for sale and rent in ${location.nameEn}, ${islandLabel}. ${location.shortDesc}`
      : 'Discover luxury properties across Malta.',
