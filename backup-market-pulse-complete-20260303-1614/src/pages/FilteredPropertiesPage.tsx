...
export const FilteredPropertiesPage: React.FC<FilteredPropertiesPageProps> = ({
  ...
  const pageTitle = location
    ? `${filterLabel} Properties in ${location.nameEn}, ${islandLabel} | Malta Luxury Real Estate`
    : `${filterLabel} Properties | Malta Luxury Real Estate`;

  usePageMeta({
    title: pageTitle,
    description: location
      ? `Explore ${filterLabel} properties in ${location.nameEn}, ${islandLabel}. ${properties.length} curated listings available.`
      : `Explore ${filterLabel} properties in Malta.`,
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          <div className="max-w-2xl">
            ...
            <p className="text-white/60 text-lg">
              Explore our curated selection of {filterLabel.toLowerCase()} properties in the prestigious {location.nameEn} area.
              Each property has been hand-selected for its quality and investment potential.
            </p>
          </div>
