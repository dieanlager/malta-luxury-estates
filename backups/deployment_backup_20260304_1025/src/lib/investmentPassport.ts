...
function footer(doc: jsPDF, pageNum: number, total: number) {
    ...
    txt(doc, `maltaluxuryestates.com`, 180, y + 9, DIM, 6);
}
...
export async function generateInvestmentPassport(property: Property, emailAddress: string): Promise<void> {
    ...
    const notes = [
        ...
        "• Annual rent reviewed against current listings in your area on maltaluxuryestates.com",
    ];
    ...
    const steps = [
        ...
        '5.  Contact us at info@maltaluxuryestates.com to arrange a private viewing',
    ];
