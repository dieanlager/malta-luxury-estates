...
export const InsightsHub = () => {
  ...
  usePageMeta({
    title: 'Malta Real Estate Knowledge Hub | Investment Guides 2026',
    description: 'Expert guides on buying property in Malta, rental tax regulations, residency by investment (MPRP), and regional market analysis for 2026.',
