...
const ARTICLE_LINK_MAP: Record<string, string> = {
    ...
    'mortgage': '/insights/getting-mortgage-malta-foreigner-guide',
    'mortgages': '/insights/getting-mortgage-malta-foreigner-guide',
...
export function injectInternalLinks(markdown: string): string {
    ...
    for (const keyword of sortedKeys) {
        ...
        // Negative lookbehind for '[' and positive lookahead check to ensure not already linked.
        // This supports modern browsers. We're matching global/case-insensitive but only replacing once.
