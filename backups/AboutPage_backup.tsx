...
export const AboutPage = () => {
    usePageMeta({
        title: 'About Us | Malta Luxury Real Estate - The Islands\' Premier Marketplace',
        description: 'Learn about Malta Luxury Real Estate, the leading platform for high-end real estate in the Maltese islands. Our mission, values, and the expertise behind the islands\' finest addresses.',
        canonicalPath: '/about'
    });
        ...
        <div className="min-h-screen bg-luxury-black pt-32">
            ...
            <section className="py-24 text-center max-w-3xl mx-auto px-6">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                    <a href="/properties/all" className="gold-gradient text-luxury-black px-10 py-4 rounded-full font-bold uppercase tracking-widest text-[11px] shadow-2xl hover:scale-105 transition-transform">
                        View Collections
                    </a>
                    <a href="/insights" className="bg-white/5 hover:bg-white/10 text-white border border-white/10 px-10 py-4 rounded-full font-bold uppercase tracking-widest text-[11px] transition-all">
                        Read Insights
                    </a>
                </div>
            </section>
