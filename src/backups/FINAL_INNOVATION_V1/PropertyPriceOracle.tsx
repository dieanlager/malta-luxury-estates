                                ...
                                <div className="lg:col-span-4 bg-black/40 border-r border-white/5 p-10 flex flex-col justify-between">
                                    ...
                                    <div className="p-6 bg-white/3 border border-white/5 rounded-2xl">
                                        ...
                                        <p className="text-[11px] text-white/60 leading-relaxed">
                                            Our algorithms process over 14,000 active listings and historical PPR data to ensure Â±5% accuracy in core zones.
                                        </p>
                                    </div>
                                </div>
                                            ...
                                            <motion.div key="step1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                                                    <div className="space-y-4">
                                                        <label className="text-[10px] font-bold uppercase tracking-widest text-white/60">Location</label>
                                                        <select
                                            ...
                                            <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                                                    <div className="space-y-4">
                                                        <div className="flex justify-between items-center">
                                                            <label className="text-[10px] font-bold uppercase tracking-widest text-white/60">Total Area</label>
                                                    ...
                                                    <div className="space-y-4">
                                                        <div className="flex justify-between items-center">
                                                            <label className="text-[10px] font-bold uppercase tracking-widest text-white/60">Beds / Baths</label>
                                                            <span className="text-white font-serif">{specs.beds}bd Â· {specs.baths}bt</span>
                                                        </div>
                                                    ...
                                                    <div className="space-y-4">
                                                        <label className="text-[10px] font-bold uppercase tracking-widest text-white/60">Finish Level</label>
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 pt-8 border-t border-white/5">
                                                    <div className="space-y-6">
                                                        <label className="text-[10px] font-bold uppercase tracking-widest text-white/60">Premium Signals</label>
                                                    ...
                                                    <div className="space-y-6">
                                                        <label className="text-[10px] font-bold uppercase tracking-widest text-white/60">View Quality</label>
                                                ...
                                                <div className="flex gap-4">
                                                    <button onClick={() => setStep(1)} className="px-10 py-5 rounded-2xl border border-white/10 text-white/60 text-xs font-bold uppercase tracking-widest">Back</button>
                                                    <button
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
                                                    ...
                                                    <div className="md:col-span-12 p-10 bg-white/3 border border-white/5 rounded-[2.5rem] relative overflow-hidden group">
                                                        ...
                                                        <div className="relative z-10 text-center">
                                                            <div className="text-[10px] font-bold uppercase tracking-[0.3em] text-white/60 mb-6">Estimated Market Value</div>
