...
const DATA = [
    ...
    { period: '2031 (Proj)', value: 181, label: 'Malta Parity', note: 'Price parity reached with Northern Malta (Mellieha/St. Paul\'s Bay range).', projection: true },
];

export function GozoBridgeTrackerClient() {
                ...
                <section className="text-center bg-gold/5 border border-gold/20 rounded-[4rem] p-16 relative overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-2xl mx-auto">
                        ...
                        <div className="flex flex-col md:flex-row justify-center gap-4">
                            <Link href="/properties/all" className="px-12 py-5 bg-gold text-luxury-black rounded-2xl text-xs font-bold uppercase tracking-widest hover:scale-105 transition-all shadow-xl shadow-gold/20">
