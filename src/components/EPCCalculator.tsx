...
export const EPCCalculator: React.FC<EPCCalculatorProps> = ({ property, isOpen, onClose }) => {
    ...
    const analysis = useMemo(() => {
        ...
        return { upgradeCost, annualSavings, paybackPeriod, bankPremium, resaleValuePremium, isHighEfficiency };
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex justify-between items-center p-4 bg-white/3 rounded-xl border border-white/5">
                                    ...
                                    <span className="text-sm font-serif text-white">{analysis.paybackPeriod} yrs</span>
                                </div>
        ...
        return (
            <>
                ...
                >
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest text-white/60 group-hover:text-gold">{t('efficiency_audit')}: {rating}</span>
                </button>
    ...
    return (
        <>
            ...
            >
                ...
                <span className="text-[9px] font-bold uppercase tracking-widest whitespace-nowrap">{t('efficiency_audit')}: {rating}</span>
            </button>
            <EPCCalculator property={property} isOpen={isOpen} onClose={() => setIsOpen(false)} />
        </>
    );
