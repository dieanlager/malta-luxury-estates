            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-16">
                    <div className="max-w-2xl">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <span className="text-gold uppercase tracking-widest text-xs font-bold">{t('interactive_tools.eyebrow')}</span>
                        </div>
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="glass-card p-10 rounded-[2.5rem] border border-gold/20 bg-gold/5 flex flex-col justify-between items-start group hover:scale-[1.02] transition-all">
                        ...
                        <Link href="/tools/valuation" className="px-8 py-4 bg-gold text-luxury-black rounded-xl text-[10px] font-bold uppercase tracking-[0.2em] hover:bg-white hover:text-black transition-all shadow-xl shadow-gold/10">
