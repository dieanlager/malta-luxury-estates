...
export const InteractiveTools = () => {
    ...
    const tabs = [
        ...
        { id: 'roi', label: 'ROI Calculator', icon: TrendingUp, color: 'text-indigo-400', bg: 'bg-indigo-400/10', border: 'border-indigo-500/30' },
                ...
                <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-16">
                    <div className="max-w-2xl">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <span className="text-gold uppercase tracking-widest text-xs font-bold">{'Malta 2026 Financial Intelligence'}</span>
                        </div>
                        <h2 className="text-4xl md:text-6xl font-serif mb-6 leading-tight">
                            {'Investment'} <span className="text-gold-gradient italic">{'Calculators'}</span>
                        </h2>
                        <p className="text-white/60 text-lg leading-relaxed">
                            {'Six professional-grade tools to model your Malta property investment, mortgage eligibility and sale proceeds.'}
                        </p>
                    </div>
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="glass-card p-10 rounded-[2.5rem] border border-gold/20 bg-gold/5 flex flex-col justify-between items-start group hover:scale-[1.02] transition-all">
                        <div>
                            ...
                            <h4 className="font-serif text-2xl mb-3 text-white">{'Property Oracle'}</h4>
