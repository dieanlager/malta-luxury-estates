...
export const NoiseAnalysisModal: React.FC<NoiseAnalysisProps> = ({ property, isOpen, onClose }) => {
    ...
    const scoreLabel = noise.score >= 80
        ? 'Exceptional acoustic environment'
        : noise.score >= 60
            ? 'Standard urban noise levels'
            : 'Higher noise exposure area';
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center justify-center mb-12">
                            <div className="relative w-40 h-40 flex items-center justify-center">
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center">
                                    ...
                                    <span className="text-[10px] uppercase tracking-widest text-white/70 font-bold">Score</span>
                                </div>
                            </div>
                            <p className="mt-6 text-sm text-white/60 text-center max-w-xs">{scoreLabel}</p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="p-5 bg-white/3 rounded-2xl border border-white/5">
                                ...
                                <div className="text-sm text-white font-medium">{noise.isFlightPath ? 'Flight Path' : 'Outside Flight Path'}</div>
                            </div>
                        </div>
                        ...
                        <div className="mt-10 p-4 bg-emerald-500/5 border border-emerald-500/20 rounded-xl flex items-center gap-4">
                            ...
                            <p className="text-[10px] text-emerald-400/80 uppercase tracking-wide leading-relaxed font-medium">
                                Verified using Malta Environment and Resources Authority data and local acoustic surveys.
                            </p>
                        </div>
                        ...
                        <div className="mt-8 flex gap-3 text-white/70">
                            ...
                            <p className="text-[9px] uppercase tracking-wider leading-relaxed">
                                Noise assessments are indicative and may vary seasonally. On-site inspection recommended.
                            </p>
                        </div>
                    </motion.div>
                </div>
