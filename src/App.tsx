...
import { CityPage } from './vite-pages/CityPage';
import { PropertiesPage } from './vite-pages/PropertiesPage';
import { InsightsHub } from './vite-pages/InsightsHub';
import { ArticlePage } from './vite-pages/ArticlePage';
import { FilteredPropertiesPage } from './vite-pages/FilteredPropertiesPage';
...
import { PrivacyPolicy, TermsOfService, CookiePolicy } from './vite-pages/legal/LegalPages';
import { MarketLive } from './vite-pages/MarketLive';
import ContactPage from './vite-pages/ContactPage';
import { PropertyPriceOracle } from './vite-pages/PropertyPriceOracle';
import { PropertyDetailPage } from './vite-pages/PropertyDetailPage';
import { GozoBridgeTrackerPage } from './vite-pages/GozoBridgeTracker';
import { MaltaPropertyQuiz } from './vite-pages/PropertyQuiz';
import { AgencyPortal } from './vite-pages/AgencyPortal';
import { AuthProvider } from './lib/auth';
import { ImgWithPlaceholder } from './components/ImgWithPlaceholder';
import { AuthGuard } from './components/AuthGuard';
import AgencyLogin from './vite-pages/agency/Login';
import AgencyRegister from './vite-pages/agency/Register';
import ForgotPassword from './vite-pages/agency/ForgotPassword';
import ResetPassword from './vite-pages/agency/ResetPassword';
import UpgradePage from './vite-pages/agency/Upgrade';
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-y-12 gap-x-8">
            {LOCATIONS.filter(l => l.isPopular).slice(0, 10).map(city => (
              ...
              >
                ...
                <span className="text-[9px] uppercase tracking-widest text-white/70 font-bold block">{t('common.estate_in', { location: city.nameEn })}</span>
