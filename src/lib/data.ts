...
export const LOCATIONS: Location[] = [
  ...
  { id: 5, slug: 'Mellieħa', nameEn: 'Mellieħa', nameMt: 'Il-Mellieħa', island: 'malta', region: 'Northern', locationType: 'city', isPopular: true, isLuxuryHub: true, shortDesc: 'Stunning villas.', lifestyleTags: ['Beachfront', 'Villa Living'] },
  ...
  { id: 15, slug: 'Għargħur', nameEn: 'Għargħur', nameMt: 'Hal Għargħur', island: 'malta', region: 'Northern', locationType: 'village' },
...
export const ALL_LOCALITIES = [
  ...
  "Dingli", "Mgarr", "Baħrija", "Żurrieq", "Qrendi", "Mqabba", "Kirkop", "Safi", "Luqa", "Gudja",
