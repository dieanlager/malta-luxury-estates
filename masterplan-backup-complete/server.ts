...
async function startServer() {
  ...
  app.get("/sitemap.xml", (req, res) => {
    const BASE = "https://maltaluxuryestates.com";
...
Sitemap: https://maltaluxuryestates.com/sitemap.xml
`);
  });
  ...
  app.post("/api/contact", async (req, res) => {
    try {
      ...
      //   from: 'Malta Luxury Real Estate <noreply@maltaluxuryestates.com>',
      //   to: 'info@maltaluxuryestates.com',
      //   replyTo: email,
