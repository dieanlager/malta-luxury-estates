...
export const PROPERTIES: Property[] = [
  ...
  },
  {
    ...
    baths: 2,
    sqm: 210,
    images: ['https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?auto=format&fit=crop&q=80&w=1600'],
    type: 'sale',
  ...
  },
  {
    ...
    baths: 1,
    sqm: 55,
    images: ['https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&q=80&w=1600'],
    type: 'sale',
    propertyType: 'Apartment',
    isSeafront: false,
  ...
  },
  {
    ...
    baths: 2,
    sqm: 160,
    images: ['https://images.unsplash.com/photo-1600607687644-c7171b42498f?auto=format&fit=crop&q=80&w=1600'],
    type: 'sale',
    propertyType: 'Apartment',
    isSeafront: false,
  ...
  },
  {
    ...
    baths: 5,
    sqm: 650,
    images: ['https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&q=80&w=1600'],
    type: 'sale',
    propertyType: 'Palazzo',
    isSeafront: true,
  ...
  },
  {
    ...
    baths: 4,
    sqm: 520,
    images: ['https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&q=80&w=1600'],
    type: 'sale',
    propertyType: 'Villa',
    isSeafront: false,
  ...
  // === VICTORIA, GOZO (locationId: 6) ===
  {
    ...
    baths: 3,
    sqm: 450,
    images: ['https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?auto=format&fit=crop&q=80&w=1600'],
    type: 'sale',
    propertyType: 'House of Character',
    isSeafront: false,
...
*   **UCA Properties**: Properties in Urban Conservation Areas often have reduced stamp duty rates.
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1506929197327-2e4b4d388279?auto=format&fit=crop&q=80&w=800',
