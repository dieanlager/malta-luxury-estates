    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${isScrolled || location.pathname !== '/' ? 'bg-luxury-black/90 backdrop-blur-lg py-4 shadow-2xl' : 'bg-transparent py-8'}`}>
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-12">
          ...
          <a href="#about" className="text-sm uppercase tracking-widest hover:text-gold transition-colors font-medium">
            About
          </a>
          <button className="px-6 py-2 border border-gold/30 rounded-full text-xs uppercase tracking-widest hover:bg-gold hover:text-luxury-black transition-all duration-300">
            List Property
          </button>
        </div>
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <div className="flex flex-col gap-8 mt-12">
              ...
              <a href="#about" onClick={() => setIsMobileMenuOpen(false)} className="text-3xl font-serif hover:text-gold transition-colors">
                About
              </a>
            </div>
          </motion.div>
...
const HomePage = ({ favorites, onToggleFavorite, onContact }: {
  ...
  const popularLocations = [
    { slug: 'sliema', name: 'Sliema', count: 245, image: 'https://images.unsplash.com/photo-1529280600423-6231993a00cc?auto=format&fit=crop&q=80&w=800' },
    ...
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20">
        <div className="absolute inset-0 z-0">
          <img
            src="https://images.unsplash.com/photo-1506929197327-2e4b4d388279?auto=format&fit=crop&q=80&w=2000"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="glass-card rounded-[3rem] p-12 md:p-20 flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1">
              ...
              <button className="gold-gradient text-luxury-black px-10 py-4 rounded-full text-xs font-bold uppercase tracking-widest hover:scale-105 transition-transform shadow-xl">
  ...
  <footer className="bg-luxury-black border-t border-white/5 pt-24 pb-12">
    <div className="max-w-7xl mx-auto px-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-24">
        ...
        <div>
          <h4 className="font-serif text-lg mb-8">Explore</h4>
          <ul className="space-y-4 text-sm text-white/40">
            <li><Link to="/properties/sliema/villas" className="hover:text-gold transition-colors">Luxury Villas</Link></li>
            <li><Link to="/properties/sliema/penthouses" className="hover:text-gold transition-colors">Seafront Penthouses</Link></li>
            <li><Link to="/properties/valletta" className="hover:text-gold transition-colors">Historic Palazzos</Link></li>
            <li><Link to="/properties/victoria" className="hover:text-gold transition-colors">Gozo Retreats</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-2">
            <input
              ...
              className="bg-white/5 border border-white/10 rounded-full px-6 py-3 text-sm flex-1 focus:border-gold outline-none transition-colors"
            />
            <button className="gold-gradient text-luxury-black px-5 py-3 rounded-full font-bold shadow-lg">
