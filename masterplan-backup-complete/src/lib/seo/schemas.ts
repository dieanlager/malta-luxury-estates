...
export function generateArticleSchema(article: {
    ...
    return {
        ...
        author: {
            ...
            url: 'https://maltaluxuryestates.com',
        },
        publisher: {
            '@type': 'Organization',
            name: 'Malta Luxury Real Estate',
            logo: {
                '@type': 'ImageObject',
                url: 'https://maltaluxuryestates.com/logo.png',
            },
        },
        mainEntityOfPage: {
            '@type': 'WebPage',
            '@id': `https://maltaluxuryestates.com/insights/${article.slug}`,
        },
    };
}
...
export function localBusinessSchema(location: {
    ...
    return {
        ...
        url: `https://maltaluxuryestates.com/properties/${location.slug}`,
        image: 'https://maltaluxuryestates.com/og-image.jpg',
        address: {
            '@type': 'PostalAddress',
